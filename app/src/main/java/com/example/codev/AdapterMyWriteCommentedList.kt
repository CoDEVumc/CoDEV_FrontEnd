...
class AdapterMyWriteCommentedList(private val context: Context, private val listData: ArrayList<BookmarkPData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){

    //뷰 홀더 바인딩
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return  ProjectItemViewHolder(context, RecycleCommunityContestListBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    //Item의 ViewHolder 객체
    inner class ProjectItemViewHolder(val context: Context, private val binding: RecycleCommunityContestListBinding): RecyclerView.ViewHolder(binding.root){
