...
class AdapterMyJoinProjectList(private val context: Context, private val listData: ArrayList<JoinData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    inner class ProjectItemViewHolder(val context: Context, private val binding: RecycleRecruitListBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(data: JoinData, position: Int){
            //프로젝트 제목
