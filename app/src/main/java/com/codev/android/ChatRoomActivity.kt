...
import com.codev.android.databinding.ActivityChatRoomBinding
...
class ChatRoomActivity:AppCompatActivity() {
    ...
    private lateinit var adapter: com.codev.android.AdapterChatList
...
//                viewBinding.chatList.smoothScrollToPosition(viewBinding.chatList.adapter?.itemCount ?: 0)
    ...
    private fun setAdapter(context: Context, dataList: ArrayList<ResponseOfGetChatListData>, isRead: Int){
        adapter = com.codev.android.AdapterChatList(context, dataList) {
            ...
            recyclerViewPosition =
                (viewBinding.chatList.layoutManager as LinearLayoutManager).findFirstVisibleItemPosition()
        }
