...
class AdapterMyBookmarkStudyList(private val context: Context, private val listData: ArrayList<BookmarkSData>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    inner class StudyItemViewHolder(val context: Context, private val binding: RecycleRecruitListBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(data: BookmarkSData, position: Int){
            //스터디 제목
